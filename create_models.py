content = open("app/models.py", "w", encoding="utf-8")
content.write("""from sqlalchemy import Column, String, Boolean, Float, Integer, Text, ForeignKey, DateTime, Enum
